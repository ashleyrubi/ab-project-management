...
import { Plus, Search, Users, User, ChevronRight, X, RefreshCw } from 'lucide-react';
          ...
          filteredClients.map((client) => {
            ...
            return (
              <Link
                ...
                className="bg-white px-6 py-8 rounded-3xl border border-gray-100 shadow-sm hover:shadow-md transition-all group w-full"
              >
