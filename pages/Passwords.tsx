...
const Passwords: React.FC = () => {
  ...
  const handleAddRow = async (atTop: boolean) => {
    ...
    try {
      ...
      const entryWithId = { ...newEntry, id: docRef.id } as PasswordEntry;
              ...
              {filteredPasswords.length === 0 ? (
                <tr>
                  <td colSpan={6} className="py-32 text-center">
                    <p className="text-gray-400 font-bold uppercase tracking-widest text-[10px]">Vault is currently empty</p>
                  </td>
                </tr>
              ) : (
                  ...
                  <tr key={p.id} className="group hover:bg-gray-50 transition-colors align-top">
                    ...
                    <td className="p-4">
                      <input 
                        ...
                        placeholder="Graphic design suite"
